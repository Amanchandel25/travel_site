	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children ) {
				$classes[] = 'dropdown dropdown-hover';
			}
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'andaaz') . '">' . esc_html__( 'Add a menu', 'andaaz') . '</a></li>';
			$fallback_output .= '</ul>';
